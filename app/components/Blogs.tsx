...
export function Blogs({
 ...
 const sectionClassName = showText ? "py-18.5 lg:py-37.5" : "pt-10 pb-18.5 lg:pt-14 lg:pb-37.5";
 const listClassName = showText
  ? "my-10 space-y-4 lg:my-20 lg:grid grid-cols-3 gap-x-6"
  : "mt-5 space-y-4 lg:mt-10 lg:grid grid-cols-3 gap-x-6";
