  ...
  return(
    <>
     <div className="p-4 border bg-white border-black/10 rounded-xl lg:rounded-4xl space-y-8">
            ...
            <img className="absolute top-0 left-0 w-full h-full object-cover rounded-xl lg:rounded-3xl" src={service.image} alt={service.title} />
            </div>
...
export function Services({blogs=[]}:{blogs?:FlattenedBlogPost[]}) {
  return (
